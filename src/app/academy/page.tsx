...
export const metadata: Metadata = buildPageMetadata({
  title: NOVA_ACADEMY.metadataTitle,
  description: NOVA_ACADEMY.description,
  path: "/academy",
});
  ...
  return (
    <div className="relative flex flex-1 flex-col">
      <main className="relative flex-1">
          ...
          <div className="nova-container relative grid items-center gap-12 lg:grid-cols-2">
            <div>
              ...
              <p className="mt-6 max-w-xl text-lg text-nova-cyan-light/90">
                {NOVA_ACADEMY.description}
              </p>
              <div className="mt-8 flex flex-wrap gap-4">
                <Link
                  href={NOVA_COLLEGE.path}
                  className="nova-btn-primary nova-btn-glow bg-nova-orange hover:bg-nova-orange/90"
                >
                  {NOVA_COLLEGE.name}
                </Link>
                <Link
        ...
        <section id="mission" className="nova-space-section">
          <div className="nova-container">
            <div className="nova-glass-island mx-auto grid max-w-5xl gap-8 p-8 md:grid-cols-2 md:items-center md:p-12">
              <div>
                ...
                <p className="mt-4 text-nova-cyan-light/85">
                  {NOVA_STEM_HUB_IMPACT.mission.body}
                </p>
                <p className="mt-3 text-sm text-nova-cyan-light/60">
                  Scholarships, institutional partnerships, and {NOVA_COLLEGE.name} —{" "}
                  {NOVA_COLLEGE.trackCount} tracks including the {QUANTUM_WORKFORCE.shortName}{" "}
                  quantum program — verifiable employability.
                </p>
                <div className="mt-6 flex flex-wrap gap-3">
                  <Link
                    href={NOVA_STEM_HUB_IMPACT.missionPath}
                    className="nova-btn-primary nova-btn-glow inline-flex bg-nova-orange hover:bg-nova-orange/90"
                  >
                    Our mission
                  </Link>
                  <Link
                    href={NOVA_STEM_HUB_IMPACT.scholarshipsPath}
                    className="nova-btn-secondary inline-flex border-white/20 text-white hover:bg-white/10"
                  >
              ...
              <div className="grid gap-4 sm:grid-cols-2">
                {NOVA_STEM_HUB_IMPACT.pillars.slice(0, 4).map((pillar) => (
                  <div key={pillar.id} className="rounded-xl border border-white/10 bg-white/5 p-4">
                    ...
                    <p className="mt-2 text-sm text-nova-cyan-light/70">{pillar.description}</p>
                  </div>
                ))}
              </div>
            </div>
        ...
        <section id="portal" className="nova-space-section">
          <div className="nova-container">
            ...
            <p className="mb-2 text-sm font-semibold uppercase tracking-wider text-nova-cyan">
              {NOVA_ACADEMY.portalName}
            </p>
            <h2 className="text-2xl font-bold text-white sm:text-3xl">
              Enter the {NOVA_ACADEMY.portalName}
            </h2>
        ...
        <section id="contact" className="nova-space-section pb-24 text-white">
          <div className="nova-container text-center">
            ...
            <p className="mx-auto mt-4 max-w-xl text-nova-cyan-light/80">
              Connect with {NOVA_ACADEMY.name} to learn about Explorer enrollment, mentorship, and sponsorship
              opportunities.
            </p>
