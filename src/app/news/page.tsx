...
export const metadata: Metadata = buildPageMetadata({
  title: "News | STEM market & skills briefings",
  description:
  ...
  return (
    <div className="relative flex flex-1 flex-col">
      <section className="nova-section-cosmic relative overflow-hidden border-b border-white/10 py-16 text-white">
        ...
        <PageHero
          title="News"
          description="A calm, high-signal place to scan STEM market trends tied to what we teach—AI &amp; coding, robotics, IoT, quantum, languages, digital skills, and careers. Come curious. Leave oriented."
        >
